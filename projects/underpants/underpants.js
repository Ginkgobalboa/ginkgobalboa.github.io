...
*   _.identity({a: "b"}) === {a: "b"}
*/
//Create a function that takes a value an returns the value unchanged
...
*/
// Create a function that takes a value of any datatype and returns its datatype as a string 
_.typeOf = function (value) {
    // if the typeof the value is undefined
...
_.first = function (array, number){
    // Create a variable newArray and set it equal to an array literal
    let newArray = [];
    // if the the array value is not an array or if the number is < 0
    if (Array.isArray(array) === false || number < 0){
        // return an empty array
        return [];
    //else if the typeof the number value does not equal number or the number value is null
    } else if (typeof number !== "number" || number === null){
         //return the first element of the array
         return array[0];
    // otherwise, use the slice method to return the elements of the array from 0 to number
    // set equal to newArray
    } else {
...
_.last = function (array, number) {
    // is the array is not an array or the number is < 0
    if (Array.isArray(array) === false || number < 0){
        // return an empty array
        return [];
    //else if the typeof the number value doesn't equal "number" or if the number value is null
    } else if (typeof number !== "number" || number === null){
         //return the last element in the array
         return array[array.length - 1];
    // otherwise, return an array containing elements of the input array from 
    // the last element of the array counting back number amount of elements
    } else {
